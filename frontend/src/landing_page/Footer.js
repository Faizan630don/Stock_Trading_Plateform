        ...
        <div className='container mt-5 p-5 border-top' >
            <div className='row'>
                ...
                <div className='col-12 col-md-3 p-5'>
                    ...
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>NRI demat account</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Commodity</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Dematerialisation</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Fund transfer</a>
                ...
                <div className='col-12 col-md-3 p-5'>
                    ...
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>How to file a complaint?</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Status of your complaints</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Bulletin</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Circular</a>
                ...
                <div className='col-12 col-md-3 p-5'>
                    ...
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Press & media</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Careers</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Zerodha Cares (CSR)</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Zerodha.tech</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Open source</a>
                    <a href='#' className='footer-link text-muted d-block text-decoration-none mt-2'>Policies</a>
                </div>
            </div>
            <p className='text-muted Footer-line col-12'>
                <p>
            Zerodha Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through Zerodha Commodities Pvt. Ltd. MCX: 46025; SEBI Registration no.: INZ000038238 Registered Address: Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to <a href=''>complaints@zerodha</a> complaints@zerodha.com, for DP related to <a href=''>dp@zerodha.com.</a> Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF
</p>
<p>
